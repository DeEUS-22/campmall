...
<link rel="stylesheet"
	href="http://localhost:9000/campmall/resources/css/product.css">
			...
			<div class="product_inner">
				<div class="product_top clearfix">
					...
					<div class="right">
						...
						<input type="hidden" name="bsale" value="${vo.sale}">
				...
				<div id="first" class="product_menu">
					<ul class="clearfix">
						<li class="active"><a href="#first">상세정보</a></li>
						<li><a href="#second">상품후기</a></li>
						<li><a href="#third">교환 및 반품 안내</a></li>
					</ul>
				</div>
				<div class="product_image">
					<img
						src="http://localhost:9000/campmall/resources/images/air_300_06.jpg"
						alt="#">
				</div>

				<div id="second" class="product_menu">
					<ul class="clearfix">
						<li><a href="#first">상세정보</a></li>
						<li class="active"><a href="#second">상품후기</a></li>
						<li><a href="#third">교환 및 반품 안내</a></li>
					</ul>
				</div>
					...
					<table>
						...
						<tbody>
							<tr>
								<td>10</td>
								<td class="td_img"><img
									src="http://localhost:9000/campmall/resources/images/0240030006612.jpg"
									alt="#"></td>
								<td class="left"><a href="#">리뷰 제목입니다.</a></td>
								<td>김수환</td>
								<td>2023-03-29</td>
								<td>100</td>
							</tr>
				...
				<div id="third" class="product_menu">
					<ul class="clearfix">
						<li><a href="#first">상세정보</a></li>
						<li><a href="#second">상품후기</a></li>
						<li class="active"><a href="#third">교환 및 반품 안내</a></li>
					</ul>
				</div>
				<div class="product_refund">
					<table>
						...
						<tbody>
							<tr>
								<th>배송안내</th>
								<td><b>제품 수령 후 구성품을 꼭 확인해주세요.</b><br> 수령 후 30일이 지난 제품의
									구성품 누락 및 오배송에 대한 문의는 당사에서 해결해 드리기 어려우니, <br>반드시 수령 후 구성품과
									제품확인으로 문제가 없는지 확인해주시기 바랍니다.<br>
								<br> <b>제품 사진은 촬영시 카메라 플래쉬, 모니터에 따라 실제 제품 이미지와 다소 차이가
										있을 수 있습니다.</b><br>
								<br> <b>제품 실측 사이즈는 측정에 따라 실제 사이즈와 약간의 오차가 발생할 수 있습니다.</b><br>
								<br> <b>주문상품 배송은 결제 확인 후 2~5일 정도 소요되며, 제품에 따라 배송일이 지연될
										수 있음을 양해바랍니다.</b><br>
								<br> <b>택배사는 로젠택배를 이용하고 있으며, 배송 및 택배 관련 문의는 1588-9988
										로젠택배로 문의하시기 바랍니다.</b><br>
								<br> <b>총 결제금액 50,000원 미만시 배송비 3,000원이 청구됩니다.(도서 산간지역
										별도 적용)</b><br>
								<br> <b>제품에 따라 묶음배송 불가상품이 있으며, 주문금액과 상관없이 별도 배송비가 부과될 수
										있습니다.</b></td>
							</tr>
							<tr>
								<th>교환/반품안내</th>
								<td><b>교환/반품이 가능한 경우</b><br> - 단순변심으로 인한 교환/반품은 왕복배송비를
									고객님께서 지불해 주셔야 합니다.<br> - 초기불량, 배송오류는 오캠몰에서 왕복 택배비를 부담하여 교환
									및 반품처리 해드립니다.<br>
								<br> <b>교환/반품이 불가능한 경우</b><br> - 상품 수령 후 7일을 초과한 경우 변심
									또는 제품 만에 대한 교환/반품은 불가합니다.(디자인,사이즈,실측정보,소재,색상,스크래치,실밥 등)<br>
									...
									불가합니다.<br> - 세탁,수선 등 취급부주의로 인하여 상품이 훼손된 경우 교환/반품이 불가합니다.</td>
							</tr>
							<tr>
								<th>A/S안내</th>
								<td><b>제품 A/S는 반드시 손상된 제품이 입고되어야 A/S가 가능합니다.</b><br>
								<br> <b>본사제품의 경우 제품 결함에 의한 수리는 제품 구입일로부터 30일간 무상 A/S를
										받으실 수 있습니다.</b><br> 그외 A/S는 모두 유상 수리로 진행되며, 일부 손상 정도에 따라 A/S가
									불가할 수 있습니다.<br>
								<br> <b>자세한 A/S 정책은 AS라운지의 게시판을 참고해 주시기 바랍니다.</b></td>
							</tr>
							<tr>
								<th>교환/반품/AS 주소</th>
								<td><b>주소 : (13550) 경기도 성남시 분당구 대왕판교로 361번길(궁내동) 오캠몰</b> <br>
									<b> 연락처 : 031-712-4371</b><br>
								<br> 교환/반품/AS접수는 로젠택배(1588-9988)로 전화하셔서 배송 운송장 번호 또는 개별접수로
									반송해 주시면 됩니다.</td>
							</tr>
						</tbody>
					</table>
